...
# 样式规范 - 符合CLAUDE.md
COLORS = [
    'rgba(72,121,128,0.7)',   # 深蓝绿 - primary
    'rgba(216,81,23,0.7)',    # 橙色 - accent
    'rgba(4,115,192,0.7)',    # 蓝色 - data
    'rgba(179,53,56,0.7)',    # 红色 - critical
    'rgba(104,57,132,0.7)',   # 紫色 - secondary
    'rgba(36,113,158,0.7)',   # 深蓝 - comparison
    'rgba(125,193,191,0.7)',  # 青绿 - positive
...
@app.callback(
    ...
    [Input('interval-component', 'n_intervals'),
     Input('simulation-data', 'data')],  # 监听Store变化
